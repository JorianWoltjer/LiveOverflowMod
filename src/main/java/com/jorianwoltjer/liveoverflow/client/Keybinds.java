...
import static com.jorianwoltjer.liveoverflow.LiveOverflowMod.LOGGER;


public class Keybinds {
    public static final String LIVEOVERFLOW_CATEGORY = "category.liveoverflow";
    ...
    private static final KeyBinding worldGuardBypassToggle = new KeyBinding("key.liveoverflow.worldguardbypass_toggle",
                GLFW.GLFW_KEY_SEMICOLON, LIVEOVERFLOW_CATEGORY);  // Bypass WorldGuard region protection
    private static final KeyBinding reachKeybind = new KeyBinding("key.liveoverflow.reach",
            GLFW.GLFW_KEY_BACKSLASH, LIVEOVERFLOW_CATEGORY);  // Hit the nearest player from far away
    private static final KeyBinding panicKeybind = new KeyBinding("key.liveoverflow.panic",
